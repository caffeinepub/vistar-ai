...
export class Backend implements backendInterface {
    ...
    async getTotalWaitlistCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalWaitlistCount();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getUserPosition(arg0: Email): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async submitEmail(arg0: Email): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitEmail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
